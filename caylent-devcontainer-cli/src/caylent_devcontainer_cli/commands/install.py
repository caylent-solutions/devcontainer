...
def install_cli():
    ...
    if not os.path.exists(script_path):
        ...
        script_path = os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(__file__)))), "bin/cdevcontainer")
    ...
    if os.path.exists(install_path):
        if not confirm_action(f"The Caylent Devcontainer CLI is already installed at:\n{install_path}\nDo you want to overwrite it?"):
            sys.exit(1)
